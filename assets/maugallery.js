        ...
        (a.fn.mauGallery.methods = {
            ...
            openLightBox(t, e) {
                a(`#${e}`).find(".lightboxImage").attr("src", t.attr("src")),
                    a(`#${e}`).on("shown.bs.modal", function () {
                        a("body").css("overflow", "auto");
                    }),
                    a(`#${e}`).on("hidden.bs.modal", function () {
                        a("body").css("overflow", "auto");
                    }),
                    a(`#${e}`).modal("toggle");
            },
            ...
            nextImage() {
                ...
                a(l).each(function (e) {
                    ...
                    console.log("index:", i),
                    console.log("imagesCollection:", l),
                    console.log("imagesCollection[index]:", l[i]),
                    (s = l[i + 1] || l[0]),
                    a(".lightboxImage").attr("src", a(s).attr("src"));
            },
            ...
            filterByTag() {
                if (!a(this).hasClass("active-tag")) {
                    a(".active-tag").removeClass("active active-tag"), a(this).addClass("active active-tag");
